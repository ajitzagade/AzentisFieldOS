...
2. **Given** a Site with zero Site Contracts, **when** I open its detail page, **then** the Subcontractors section shows a clear empty state with an "Add Subcontractor" action, not a blank section. (AD-6)

...
export const HELP_CONTENT = {
  ...
  modules: [
    ...
    },
    {
      ...
      usedBy: ["OWNER_ADMIN", "SITE_SUPERVISOR"],
      howToUse: [
        "Open Movements → Record Material Movement (or Record Material Transfer for site-to-site).",
    ...
    },
    {
      ...
      howToUse: [
        "Open Movements → Record Material Consumption (or record it inside today's Daily Report).",
  ...
  guides: [
    {
      ...
      steps: [
        { title: "Open Movements", detail: "From the sidebar, open Movements, then Record Material Consumption — or add it directly inside today's report." },
        ...
        { title: "Consumption Date", detail: "Today's date is already filled in. Change it only if you're recording an earlier day's usage." },
        ...
        { title: "Record Material Consumption", detail: "Tap Record Material Consumption — that's it, the entry is saved." },
      ],
...
export const SEARCH_ACTIONS: SearchAction[] = [
  ...
  // list.
  {
    ...
    keywords: ["record movement", "record material movement", "material sent", "godown to site", "transfer"],
  ...
  },
  {
    ...
    keywords: ["record consumption", "record material consumption", "material used"],
    href: "/movements/consumption/new",
  },
  {
    id: "record-wastage",

...
describe("icon set", () => {
  it("exports exactly 41 distinct icon components (26 from _shared-kit.html + PencilIcon from story 2.3 + Mail/Phone/Calendar/Lock/Hash/User added for form-field leading icons + Menu/X added for the responsive mobile-nav drawer + ChevronsUpDown/Check added for the ComboboxField picker + Info/HelpCircle added for the Help & Guides contextual-help bubble and nav item + Printer added for photo-gallery print + Trash added for photo delete)", () => {
    expect(iconEntries).toHaveLength(41);
  });

...
export const cardVariants = cva(
  "bg-surface-1 border border-border-hairline rounded-lg shadow-2 p-6 transition-[box-shadow,transform] duration-(--default-transition-duration) ease-(--ease-standard)",
  {
    variants: {
      interactive: {
        true: "cursor-pointer hover:shadow-2-hover hover:-translate-y-0.5",
        false: "",
      },
    },
    defaultVariants: {
